...
$sql ="SELECT EmailId,Password,Status,id FROM tblemployees WHERE ( EmailId=:uname or EmpId=:uname ) and Password=:password";
                          ...
                          <div class="col-md-6 d-flex justify-content-center align-items-center">
                              <div class="card white darken-1">
                                  ...
                                  <div class="card-content ">
                                      <span class="card-title text-center text-danger" style="font-size:20px;">Employee Login</span>
                                       ...
                                       <div class="row">
                                           <form class="col col-md-12 " name="signin" method="post">
                                               <div class="input-field col s12">
                                                   ...
                                                   <label for="email">Enter Registered Email Id / Emp id</label>
                                               </div>
